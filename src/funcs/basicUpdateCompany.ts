...
export enum UpdateCompanyAcceptEnum {
 ...
 */
export function basicUpdateCompany(
  client: HubspotCore,
  request: operations.UpdateCompanyRequest,
  options?: RequestOptions & { acceptHeaderOverride?: UpdateCompanyAcceptEnum },
): APIPromise<
  Result<
...
> {
  ...
  >(
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.bytes("default", operations.UpdateCompanyResponse$inboundSchema, {
      ctype: "*/*",
    }),
  )(response, req);
  if (!result.ok) {
