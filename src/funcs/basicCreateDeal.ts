...
export enum CreateDealAcceptEnum {
...
> {
  ...
  const path = pathToFunc("/crm/v3/objects/deals")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateDealResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.bytes("default", operations.CreateDealResponse$inboundSchema, {
      ctype: "*/*",
    }),
  )(response, req);
  if (!result.ok) {
