...
export enum GetPropertiesAcceptEnum {
 ...
 */
export function basicGetProperties(
  client: HubspotCore,
  request: operations.GetPropertiesRequest,
  options?: RequestOptions & { acceptHeaderOverride?: GetPropertiesAcceptEnum },
): APIPromise<
  Result<
...
> {
  ...
  const path = pathToFunc("/crm/v3/properties/{objectType}")(pathParams);
  ...
  >(
    ...
    M.fail("4XX"),
    M.fail("5XX"),
    M.bytes("default", operations.GetPropertiesResponse$inboundSchema, {
      ctype: "*/*",
    }),
  )(response, req);
  if (!result.ok) {
