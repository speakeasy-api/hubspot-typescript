...
export enum GetCompanyAcceptEnum {
...
> {
  ...
  const path = pathToFunc("/crm/v3/objects/companies/{companyId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCompanyResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.bytes("default", operations.GetCompanyResponse$inboundSchema, {
      ctype: "*/*",
    }),
  )(response, req);
  if (!result.ok) {
