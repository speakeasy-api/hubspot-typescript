...
import { HubspotError } from "../models/errors/hubspoterror.js";
...
export enum CreateContactAcceptEnum {
 ...
 */
export function basicCreateContact(
  client: HubspotCore,
  request: components.SimplePublicObjectInputForCreate,
  options?: RequestOptions & { acceptHeaderOverride?: CreateContactAcceptEnum },
): APIPromise<
  Result<
    operations.CreateContactResponse,
    | HubspotError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.SimplePublicObjectInputForCreate$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/crm/v3/objects/contacts")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.CreateContactResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.bytes("default", operations.CreateContactResponse$inboundSchema, {
      ctype: "*/*",
    }),
  )(response, req);
  if (!result.ok) {
