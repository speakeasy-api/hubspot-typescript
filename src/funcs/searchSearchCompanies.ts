...
export enum SearchCompaniesAcceptEnum {
 ...
 */
export function searchSearchCompanies(
  client: HubspotCore,
...
> {
  ...
  const path = pathToFunc("/crm/v3/objects/companies/search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SearchCompaniesResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
    M.bytes("default", operations.SearchCompaniesResponse$inboundSchema, {
      ctype: "*/*",
    }),
  )(response, req);
  if (!result.ok) {
